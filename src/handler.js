...
const editBookWithIdHandler = (request, h) => {
    ...
    if (request.payload.name === undefined) {
        return customResponse("fail", "Gagal memperbarui buku. Mohon isi nama buku", 400);
    }

    if (request.payload.readPage > request.payload.pageCount) {
        return customResponse("fail", "Gagal memperbarui buku. readPage tidak boleh lebih besar dari pageCount", 400);
    }
